...
<div class="mt-10 text-right">
    <a href="{{route('products.create')}}" class="bg-amber-600 text-white p-3 rounded-lg">Add Products</a>
</div>
        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td class="border p-3">
                    ...
                    <a href="{{route('products.delete',$product->id)}}" class="bg-red-500 text-white p-2 rounded-lg">Delete</a>
                </td>
            </tr>
            @endforeach
        </tbody>
